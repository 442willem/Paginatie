 ...
 * @author lander
 */
public class viewJuist extends javax.swing.JFrame {
    ...
    */
    public void update(Instructie currentInstruction, Instructie previousInstruction) {
        ...
        if(currentInstruction != null) {
            this.currentIdValueLabel.setText(Integer.toString(currentInstruction.getId()));
            this.currentVirtualAddressValueLabel.setText(Integer.toString(currentInstruction.getAdres()));
            this.currentOperationValueLabel.setText(currentInstruction.getOperatie());
        }
        else {
        ...
        if(previousInstruction != null) {
            this.previousIdValueLabel.setText(Integer.toString(previousInstruction.getId()));
            this.previousVirtualAddressValueLabel.setText(Integer.toString(previousInstruction.getAdres()));
            this.previousOperationValueLabel.setText(previousInstruction.getOperatie());
        }
    }
    ...
    public void updateProcessTable(ArrayList<Proces> processList) {
    ...
    void updateFrames(Pagina[] frames) {
        if(frames[0] != null) {
            jLabel3.setText("PID: " + Integer.toString(frames[0].getId()));
            jLabel16.setText("Page NR: " + Integer.toString(frames[0].getPaginaNummer()));

            jLabel18.setText("PID: " + Integer.toString(frames[1].getId()));
            jLabel19.setText("Page NR: " + Integer.toString(frames[1].getPaginaNummer()));

            jLabel21.setText("PID: " + Integer.toString(frames[2].getId()));
            jLabel22.setText("Page NR: " + Integer.toString(frames[2].getPaginaNummer()));

            jLabel33.setText("PID: " + Integer.toString(frames[3].getId()));
            jLabel34.setText("Page NR: " + Integer.toString(frames[3].getPaginaNummer()));

            jLabel36.setText("PID: " + Integer.toString(frames[4].getId()));
            jLabel37.setText("Page NR: " + Integer.toString(frames[4].getPaginaNummer()));

            jLabel24.setText("PID: " + Integer.toString(frames[5].getId()));
            jLabel25.setText("Page NR: " + Integer.toString(frames[5].getPaginaNummer()));

            jLabel27.setText("PID: " + Integer.toString(frames[6].getId()));
            jLabel28.setText("Page NR: " + Integer.toString(frames[6].getPaginaNummer()));

            jLabel30.setText("PID: " + Integer.toString(frames[7].getId()));
            jLabel31.setText("Page NR: " + Integer.toString(frames[7].getPaginaNummer()));

            jLabel39.setText("PID: " + Integer.toString(frames[8].getId()));
            jLabel44.setText("Page NR: " + Integer.toString(frames[8].getPaginaNummer()));

            jLabel61.setText("PID: " + Integer.toString(frames[9].getId()));
            jLabel62.setText("Page NR: " + Integer.toString(frames[9].getPaginaNummer()));

            jLabel46.setText("PID: " + Integer.toString(frames[10].getId()));
            jLabel47.setText("Page NR: " + Integer.toString(frames[10].getPaginaNummer()));

            jLabel64.setText("PID: " + Integer.toString(frames[11].getId()));
            jLabel65.setText("Page NR: " + Integer.toString(frames[11].getPaginaNummer()));
        }
        else {
            resetFrames();
        }
    ...
    private void initComponents() {
        ...
        allInstructionsButton.addActionListener(new java.awt.event.ActionListener() {
        ...
        oneInstructionButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
